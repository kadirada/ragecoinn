...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/ragecoin-project/ragecoin.git
    sudo chmod -R a+rw ragecoin
...
It's not possible to build the ragecoin code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the ragecoin source code).
