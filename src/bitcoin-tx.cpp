...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ragecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ragecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ragecoin transaction") + "\n" +
              "  ragecoin-tx [options] -create [commands]   " + _("Create hex-encoded ragecoin transaction") + "\n" +
              "\n";
